...
var confDB = {    
    ...
    createCRMDB:function(tx){
        ...
        sql = "INSERT INTO CRMDB(id, nombreCompleto, rol, ciudad, edad, twitter, facebook, google, correoGmail, correoHotmail, telefono, ultimos) VALUES (1, 'Jose Igualada', 'Estudiante', 'Torrent', 21, 1, 1, 1, 'joseigualada@gmail.com', 'joseigualada@hotmail.com', '676170946', '0')";
        tx.executeSql(sql);
